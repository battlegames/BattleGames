...
public interface BattleBedWar extends BattleModeController {
    @Nullable
    TeamManager<BWTeam> getTeamManager(@Nullable LocalGame game);

    @Nullable
    BWTeam getTeamFromBed(@Nullable BlockPosition position);
}
